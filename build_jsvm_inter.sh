...
do_configure() {
    ...
    ${CMAKE_PATH} \
        ...
        -DJSVM_ENABLE_API_ACCESS_SCOPE=${JSVM_ENABLE_API_ACCESS_SCOPE:-1}\
        -DJSVM_ENABLE_API_TRACE=${JSVM_ENABLE_API_TRACE:-0}\
        -DJSVM_ENABLE_API_ACCESS_AUDIT=${JSVM_ENABLE_API_ACCESS_AUDIT:-0}
}
...
do_env() {
    ...
    argurment+=" -DV8_COMPRESS_POINTERS -DV8_COMPRESS_POINTERS_IN_SHARED_CAGE -DV8_31BIT_SMIS_ON_64BIT_ARCH -DV8_HAVE_TARGET_OS -DV8_TARGET_OS_OHOS -DV8_ENABLE_DRUMBRAKE"
